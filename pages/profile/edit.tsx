...
const EditProfile: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    axios
      .patch(`https://api.venturenation.co/api/v1/users/${email}`, formValues, {
        headers: {
              ...
              <div className="col-7 shadows p-0">
                <div className="ps-5 shadows py-3">
                  ...
                  <p style={{ color: "#7E848E" }}>
                    Personalize and keep your profile up-to-date.
                  </p>
                </div>
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="form-group">
                      <label className="form-label" htmlFor="bio">
                        Bio (Brief description about your Profile)
                      </label>
                      ...
                      <textarea
                        ...
                        rows={5}
                        className="form-control"
                        placeholder="Passionate Entrepreneur with a drive to innovate and disrupt industries"
