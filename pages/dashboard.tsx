...
const Dashboard: React.FC = () => {
  ...
  React.useEffect(() => {
    axios
      .get(`https://api.venturenation.co/api/v1/users/${email}/courses`, {
        headers: {
    ...
    if (course.length !== 0) {
      course.map((data: { slug: string }) => {
        ...
        axios
          .get(
            `https://api.venturenation.co/api/v1/users/${email}/course/${data.slug}/has-completed-course`,
            {
              headers: {
                Authorization: `Bearer ${token}`,
              },
                      ...
                      <div className="row px-4">
                        {course?.map(
                          (
                            ...
                            i: React.Key | null | undefined | number
                          ) => {
                            return (
                              <div className="col-md-4 col-sm-6" key={i}>
                                ...
                                <div className="card-body">
                                  <h6 className="card-title pt-3 pb-2">
                                    {data.title}
                                  </h6>
              ...
              <div className="bg-white me-3">
                <div className={styles.section__session}>
                  ...
                  <div className={styles.section__session__body}>
                    ...
                    <div className="p-2 shadows px-4 mb-4">
                      <h6>
                        Mentorship with <span>James Mary</span>
                      </h6>
                      <div className="d-flex justify-content-between">
                        <div className="d-flex">
                          <Image src={calender} alt="calender" />
                    ...
                    <div className="p-2 shadows px-4 mb-2">
                      <h6>
                        Mentorship with <span>Travis Crosby</span>
                      </h6>
                      <div className="d-flex justify-content-between">
                        <div className="d-flex">
                          <Image src={calender} alt="calender" />
