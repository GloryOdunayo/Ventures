                    ...
                    <div className="ps-3">
                      {
                        ...
                        user.avatar ? (
                          <img
                            src={user.avatar}
                            alt="Profile Image"
                            className={styles.section__info__profile__image}
                          />
                        ) : (
                          <Image
                            src={profile}
                ...
                <div className="mt-lg-5 mt-sm-3">
                  <div className={styles.section__info__end}>
                      ...
                      <div className="d-flex justify-content-between">
                        ...
                        <div className="float-end pe-3">
                          <div className={styles.section__info__text}>
                            <Link
                              href="ventures/add"
                              className={`btn px-3 py-2 text-decoration btn-outline-${styles.clr}`}
                            >
                    ...
                    <div className="row justify-content-between px-4">
                      <div
                        className="col-md-4 col-sm-6 shadows ps-4"
                        onClick={venture}
                      >
                        <Image
                          src={image2}
                          alt="venture banner"
                          className={styles.section__info__end__venture}
                        />
                        <Image
                          src={company}
                          alt="venture logo"
                          className={styles.section__info__end__venture__logo}
                        />
                        <h4 className={styles.venture__text}>Venture Name</h4>
                        <p className={styles.venture__text__p}>
                          Lorem ipsum, dolor sit amet consectetur adipisicing
                          elit. Illum, eos ex dolor accusamus eaque omnis
                        </p>
                        <div className={styles.icons}>
                          <div className="d-flex me-4">
                            ...
                            />
                            {user.nationality ? (
                              <p className="pt-1">{user.nationality}</p>
                            ) : (
                              <p className="pt-1">Lagos, Nigeria</p>
                            )}
                          </div>
                          <div className="d-flex">
                            <Image
                              ...
                              className="mt-2"
                            />{" "}
                            <span className="pt-1">18 Team members</span>
                          </div>
                        </div>
                      </div>
                      <div
                        className="col-md-4 col-sm-6 shadows ps-3 pe-3"
                        onClick={venture}
                      >
                        <Image
                          src={image2}
                      ...
                      <div
                        className="col-md-4 col-sm-6 shadows pe-4"
                        onClick={venture}
                      >
                        <Image
                          src={image1}
                    ...
                    <div className={styles.section__session__body}>
                      {user.phone ? (
                        <div className="p-2 px-4">
                          ...
                          <span className="text-dark ps-1">Phone</span>
                          <div className="d-flex justify-content-between">
                            <p className="ps-4">
                              {" "}
                              {user.phone
                      ...
                      {user.website ? (
                        <div className="p-2 px-4">
                          <Image src={website} alt="phone icon" />{" "}
                          <span className="text-dark ps-1">Website</span>
                          <div className="d-flex justify-content-between">
                            <p className="ps-4">
                              {" "}
                              {user.website
                      ...
                      {user.email ? (
                        <div className="p-2 px-4 mb-3">
                          ...
                          <Image src={mail} alt="phone icon" />{" "}
                          <span className="text-dark ps-1">Email address</span>
                          <div className="d-flex justify-content-between">
                        ...
                        {social.linkedin ? (
                          <div className="pb-4">
                            <div className="d-flex">
                              ...
                              <div
                                className="text-white px-2 py-1 rounded-1"
                                style={{
                            ...
                            <Link
                              ...
                              className="text-decoration ps-5"
                            >
                              view likened profile{" "}
