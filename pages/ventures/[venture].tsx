...
const Venture: React.FC = () => {
  ...
  React.useEffect(() => {
    ...
    axios
      .get(
        `https://api.venturenation.co/api/v1/ventures/${router.query.venture}`,
        {
          headers: {
      ...
      <div className="container-fluid">
        ...
        <div className={styles.section}>
            ...
            <div className="col-9 shadows">
              <div className="mt-3">
                <Image
                  src={image1}
                  alt="venture banner"
                  className={styles.venture__banner}
                />
                <Image
                  src={image1}
                  alt="venture logo"
                  className={styles.venture__logo}
                />
                <div className="d-flex float-end">
                  <div className={styles.venture__btn}>
                    <Link
                      href={`/ventures/edit/${data.slug}`}
                      ...
                      {data.link ? (
                        <div className="p-2 px-4">
                          ...
                          <div className="d-flex justify-content-between">
                            <p className="ps-4">
                              {" "}
                              {data.link ? data.link : "samplewebsite.com"}{" "}
                            </p>
                          </div>
                        </div>
                      ) : (
                      ...
                      {social.twitter ? (
                        <div className="ps-2 pt-1">
                          <Link
                            ...
                            className="text-decoration"
                          >
                            <div className="bg-info text-white px-2 py-1 rounded-1">
                              <i
                ...
                {data.businessModel ? (
                  <div>
                    {data.businessModel?.map((item: any, index: any) => (
                      <h6 className="badge text-dark" key={index}>
                        {item}
                      </h6>
                    ))}
                  </div>
          ...
          <div className="row justify-content-around">
            ...
            <div className="col-5 shadows mt-4"></div>
          </div>
        </div>
      </div>
    </>
